              ...
              >
                <span
                  className={cn("px-4 py-2 rounded-lg inline-block", {
                    ...
                    "rounded-br-none":
                      !hasNextMessageFromSameUser && isCurrentUser, // only the last message that is sent concurrently from the same user has an endge border and others will be round
                    "rounded-bl-none":
